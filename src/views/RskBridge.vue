...
export default defineComponent({
  ...
  watch: {
    ...
    async activeTabTotalAddress(newValue) {
      if (newValue === "Daily") {
        await this.$data.store.dispatch("getTotalUniqueUserByDateRsk");
        this.$data.listUniqueUser =
          this.$data.store.state.totalUniqueUserByDate;
      } else {
        await this.$data.store.dispatch("getTotalUniqueUserByMonthRsk");
        this.$data.listUniqueUser =
          this.$data.store.state.totalUniqueUserByDate;
      }
    },
    async activeTabCollectedFee(newValue) {
      if (newValue === "Daily") {
        await this.$data.store.dispatch("getCollectedFeeByDateRsk");
        this.$data.listCollectedFee = this.$data.store.state.collectedFeeByDate;
      } else {
        await this.$data.store.dispatch("getCollectedFeeByMonthRsk");
        this.$data.listCollectedFee = this.$data.store.state.collectedFeeByDate;
      }
    },
    async activeTabTotalVolume(newValue) {
      if (newValue === "Daily") {
        await this.$data.store.dispatch("getTotalTradeVolumeByDateRsk");
        this.$data.listTradeVolume = this.$data.store.state.totalVolumeByDate;
      } else {
        await this.$data.store.dispatch("getTotalTradeVolumeByMonthRsk");
        this.$data.listTradeVolume = this.$data.store.state.totalVolumeByDate;
      }
    },
  },
  ...
  methods: {
    ...
    async getData() {
      ...
      this.$data.listCollectedFee = this.$data.store.state.collectedFeeByDate;
      await this.$data.store.dispatch("getTotalUniqueUserByDateRsk");
      this.$data.listUniqueUser = this.$data.store.state.totalUniqueUserByDate;
